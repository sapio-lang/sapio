...
| [jamesob-vault](jamesob-vault/) | **Vault with recovery.** Provides hot/cold spending, delayed redemption and optional CPFP outputs. The fee rate is sats per 1000 weight units, using an unsigned-size estimate that excludes witness growth; fees round up. | Native overflow, rounding and compiled-funding tests. |
