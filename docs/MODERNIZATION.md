...
| Compiler termination | Reject duplicate action names with stable typed request paths; derive guard metadata beneath each guard branch and propagate errors |
